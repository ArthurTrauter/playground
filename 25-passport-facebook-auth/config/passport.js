  ...
  module.exports = function(passport) {
    ...
    passport.use('local-signup', new LocalStrategy({
      ...
      function(req, email, password, done) {
        ...
        // asynchronous
        // User.findOne wont fire unless data is sendt back
        process.nextTick(function() {

          // find a user whose email is the same as the forms email
          // we are checking to see if teh user trying to login already exists
          User.findOne({
            'local.email': email
          }, function(err, user) {
    ...
    passport.use('local-login', new LocalStrategy({
      ...
      // callback with email and password from out form
      function(req, email, password, done) {
        ...
        User.findOne({
          ...
          // if no users found, return the message
          if (!user) {
